...
func (_q *TaskQuery) QueryTaskLogs() *TaskLogQuery {
	query := (&TaskLogClient{config: _q.config}).Query()
...
func (_q *TaskQuery) WithTaskLogs(opts ...func(*TaskLogQuery)) *TaskQuery {
	query := (&TaskLogClient{config: _q.config}).Query()
...
func (_q *TaskQuery) loadTaskLogs(ctx context.Context, query *TaskLogQuery, nodes []*Task, init func(*Task), assign func(*Task, *TaskLog)) error {

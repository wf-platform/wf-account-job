...
func (tx *Tx) init() {
	tx.RelayChain = NewRelayChainClient(tx.config)
	tx.RelayToken = NewRelayTokenClient(tx.config)
...
// applies a query, for example: RelayChain.QueryXXX(), the query will be executed
